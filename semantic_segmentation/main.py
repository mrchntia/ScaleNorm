...
def parse_args():
    ...
    parser.add_argument("--model-arch", type=str, default="monet", choices=["monet", "unet"])
...
def main():
    ...
    study_name = "pancreas_monet_scale_groups_dp_10_dice_score"
    ...
    search_space = {
        ...
        "norm_layer": ["batch"],
        "num_groups": [0],  # 0, 1, 8, 16, 32, 64, 2048
        "scale_norm": [False],  # True, False
        "seed": [788],  # 788, 374, 39
    }
